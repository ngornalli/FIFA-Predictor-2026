  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <p style={{ color: 'var(--text-muted)' }}>
        Update match scores and set status to "finished" to trigger automatic point calculation for all users. You can also edit match details like kickoff times and score multipliers.
      </p>
